...
export default function DataAreaParticipationChart({
  chartData,
  valueName,
  xValueName,
}) {
    ...
    if (active) {
      ...
      return (
        ...
        >
          ...
          <p className="total">{`Total: ${totalAbs} (${precise2(total)}%)`}</p>
          <div className="list">
            {payload &&
        ...
        <AreaChart data={chartData}>
          ...
          <defs>
            ...
            <linearGradient id="colorRed" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor={colors.red} stopOpacity={0.5} />
              <stop offset="95%" stopColor={colors.red} stopOpacity={0} />
            </linearGradient>
            <linearGradient id="colorGrey" x1="0" y1="0" x2="0" y2="1">
              <stop offset="1%" stopColor={colors.grey} stopOpacity={0.5} />
              <stop offset="99%" stopColor={colors.grey} stopOpacity={0} />
            </linearGradient>
          </defs>
          <Area
            type="monotone"
          ...
          <Area
            ...
            stroke={colors.grey}
            fill="url(#colorGrey)"
            activeDot={{stroke: `${colors.grey}`, strokeWidth: 2, r: 3}}
          />
